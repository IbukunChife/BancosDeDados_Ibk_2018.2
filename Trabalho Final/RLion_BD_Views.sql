...
SELECT Ind_Nome AS Bebidas,Ind_Cat as Categoria, Ind_Preço_Uni AS Preco FROM bebida_industri
WHERE  Ind_Qtd_Disp != 0
UNION ALL
SELECT NaS_Nome AS Bebidas, NaS_Cat as Categoria, NaS_Preço_Uni Preco FROM bebida_nat_sol
