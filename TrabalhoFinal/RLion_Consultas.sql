...
SELECT Pra_Nome AS Pratos, Pra_Preco_Uni as Preco FROM pratos
WHERE  Pra_Qtd_Disp != 0;

SELECT Ind_Nome AS Bebidas, Ind_Preco_Uni AS Preco FROM bebida_industri
WHERE  Ind_Qtd_Disp != 0;

SELECT NaS_Nome AS Bebidas, NaS_Preco_Uni Preco FROM bebida_nat_sol
